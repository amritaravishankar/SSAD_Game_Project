...
public class compare_gp_1 : MonoBehaviour
{
    public static int points_gp_1;
    private string[] ans = { "Use_Case_E"};
    ...
    void Update()  //Function used to compare if the use cases are correctly placed in the right panel and award points
    {
        ...
        points_gp_1 = num*20; //for every use case placed in the right panel, award user with 20 points

        Debug.Log("Points in gp 1: " + points_gp_1);
    }
}
