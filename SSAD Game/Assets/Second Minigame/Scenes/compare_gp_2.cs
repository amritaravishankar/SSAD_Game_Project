...
public class compare_gp_2 : MonoBehaviour
{
    public static int points_gp_2;
    private string[] ans = { "Use_Case_C", "Use_Case_D" };
    ...
    void Update() //Function used to compare if the use cases are correctly placed in the right panel and award points
    {
        ...
        points_gp_2 = num*20; //for every use case placed in the right panel, award user with 20 points

       Debug.Log("Points in gp 2: " + points_gp_2);
    }
}
